...
Prefeitura SP São Paulo: Segunda via Simplificada de IPTU segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_sp_sao_paulo_iptu2via@mcp.ai](mailto:pref_sp_sao_paulo_iptu2via@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
